...
public abstract class NotificationDocsController {
    ...
    public abstract ResponseEntity<NotificationPageResponse> getNotifications(
        @Parameter(
            description = "마지막으로 조회한 알림 ID (커서 기반 페이지네이션)",
            example = "101",
            required = false
        )
        Long lastCursorId,
    ...
    public abstract ResponseEntity<Void> registerNotificationToken(
        @RequestBody(
