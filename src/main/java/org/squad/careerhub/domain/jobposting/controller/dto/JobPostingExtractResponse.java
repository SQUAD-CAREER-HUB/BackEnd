...
import org.squad.careerhub.domain.jobposting.service.dto.JobPostingExtractServiceResponse;
...
public record JobPostingExtractResponse(
    ...
    public static JobPostingExtractResponse from(JobPostingExtractServiceResponse serviceDto) {
     ...
     */
    public static JobPostingExtractResponse sample() {
        return JobPostingExtractResponse.builder()
            .company("에어스메디컬")
