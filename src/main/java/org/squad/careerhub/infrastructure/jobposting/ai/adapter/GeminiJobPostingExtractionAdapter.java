...
@Slf4j
@Component
@Qualifier("geminiJobPostingExtractor")
public class GeminiJobPostingExtractionAdapter extends AbstractAiJobPostingExtractionAdapter {

    public GeminiJobPostingExtractionAdapter(
